...
# open embeddings
data = pd.read_pickle('./working_data/msp_train_extracted_embeddings.pk')
data_test = pd.read_pickle('./working_data/msp_test_extracted_embeddings.pk')
...
X_train_sad, y_train_sad = make_imbalance(X_sad, y_sad, sampling_strategy={0: 1666, 2: 1666},random_state=RANDOM_STATE)
X_test_sad, y_test_sad = make_imbalance(X_sad_test, y_sad_test, sampling_strategy={0: 493, 2: 493},random_state=RANDOM_STATE)
print('Balanced emotion classes')

print(Counter(y_other), Counter(y_other_test))
print(y_other)
X_train_other, y_train_other = make_imbalance(X_other, y_other, sampling_strategy={1:1835, 3: 1835, 5:1835},random_state=RANDOM_STATE)
X_test_other, y_test_other = make_imbalance(X_other_test, y_other_test, sampling_strategy={1: 1835, 3: 1835, 5:1835},random_state=RANDOM_STATE)
print('Balanced emotion classes')

print(Counter(y_full), Counter(y_full_test))
X_train_full, y_train_full = make_imbalance(X_full, y_full, sampling_strategy={1:1666,2:1666, 3: 1666, 5:1666},random_state=RANDOM_STATE)
X_test_full, y_test_full = make_imbalance(X_full_test, y_full_test, sampling_strategy={1: 493, 2:493, 3: 493, 5:493},random_state=RANDOM_STATE)
print('Balanced emotion classes')
