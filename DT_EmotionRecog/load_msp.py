...
msp = "/research/iprobe-sandle20/sandle20/MSP-Podcast/www.lab-msp.com/MSP-PODCAST-Publish-1.8/AudioFiles/Audios_wav/"
msp_directory_list = os.listdir(msp)

file_emotion = []
file_path = []
file_subject = []

for file in msp_directory_list:
    # storing file paths
    file_path.append(msp + file)
