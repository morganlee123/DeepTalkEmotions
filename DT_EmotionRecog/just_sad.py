...
#
# Tests a binary SVM classifier for Sad vs others
#
...
X_train, y_train = make_imbalance(X_train, y_train, sampling_strategy={0: 720, 2: 720},random_state=RANDOM_STATE)
X_test, y_test = make_imbalance(X_test, y_test, sampling_strategy={0: 320, 2: 320},random_state=RANDOM_STATE)
